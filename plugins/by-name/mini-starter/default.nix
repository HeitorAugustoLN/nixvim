...
lib.nixvim.plugins.mkNeovimPlugin {
  ...
  settingsExample = {
    autoopen = true;
    content_hooks = [
      (nestedLiteralLua "MiniStarter.gen_hook.adding_bullet()")
      (nestedLiteralLua "MiniStarter.gen_hook.indexing('all', { 'Builtin actions' })")
      (nestedLiteralLua "MiniStarter.gen_hook.aligning('center', 'center')")
    ];
    ...
    '';
    items = [
      (nestedLiteralLua "MiniStarter.sections.builtin_actions()")
      (nestedLiteralLua "MiniStarter.sections.recent_files(10, false)")
      (nestedLiteralLua "MiniStarter.sections.recent_files(10, true)")
      (nestedLiteralLua "MiniStarter.sections.sessions(5, true)")
    ];
  };
}
